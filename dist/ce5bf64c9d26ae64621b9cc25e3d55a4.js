...
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("p[data-v-b41628bc] {\n  font-size: 2em;\n  text-align: center;\n  color: #2e9afe;\n}");(function () {
  'use strict';
...
if (module.hot) {
  (function () {
    ...
    if (!module.hot.data) {
      hotAPI.createRecord("data-v-b41628bc", __vue__options__);
    } else {
      hotAPI.reload("data-v-b41628bc", __vue__options__);
    }
  })();
}
},{"vue":5,"vue-hot-reload-api":6,"vueify/lib/insert-css":7}],4:[function(require,module,exports) {
var global = (1,eval)("this");
"use strict";
...
var _hello = require("./vue/hello.vue");

var _hello2 = _interopRequireDefault(_hello);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var app = new _vueEsm2.default(_hello2.default);
app.$mount('#app');
},{"./vue/hello.vue":3,"vue/dist/vue.esm.js":4}],0:[function(require,module,exports) {
var global = (1, eval)('this');
...
if (!module.bundle.parent) {
    var ws = new WebSocket('ws://localhost:61282/');
    ws.onmessage = (e) => {
